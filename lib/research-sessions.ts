export const researchChecklist = [
  ...
  { key: "evidence_clustered", label: "Evidence pattern created" },
  { key: "opportunities_generated", label: "Opportunities generated" },
  { key: "validation_package_created", label: "Validation plan created" },
...
export const researchStages = ["Scoring", "Evidence Collection", "Evidence Patterns", "Opportunity Generation", "Validation", "Interviews", "Product Concepts", "Experiments", "Complete"] as const;
