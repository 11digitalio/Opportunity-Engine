...
export const sections: Record<string, SectionConfig> = {
  ...
  industries: {
    ...
    fields: [
      ...
      { key: "research_notes", label: "Research analysis", type: "textarea", full: true },
      { key: "notes", label: "Notes", type: "textarea", full: true },
    ],
  },
  workflows: {
  ...
  opportunities: {
    ...
    fields: [
      ...
      { key: "ai_opportunity", label: "Automation opportunity", type: "textarea", full: true },
      ...
      { key: "ai_leverage_score", label: "Automation Potential Score", type: "number", min: 0, max: 100, readOnly: true },
      ...
      { key: "promotion_reason", label: "Why this opportunity matters", type: "textarea", full: true, readOnly: true },
      { key: "research_notes", label: "Research analysis", type: "textarea", full: true },
      { key: "notes", label: "Notes", type: "textarea", full: true },
      reviewStatus,
    ],
