...
export default async function ResearchSessionPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const activity = db.prepare(`
    SELECT * FROM (
      ...
      UNION ALL SELECT 'cluster-' || id, 'Created Evidence Pattern', cluster_name, created_at FROM evidence_clusters WHERE research_session_id = ?
